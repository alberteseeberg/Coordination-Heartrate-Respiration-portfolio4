...
#                radius=0.596,normalize=0,rescale=0,mindiagline = 2,minvertline = 2)
# 
#     HrCRQA= crqa(data$HR1, data$HR2, delay=21, embed=14,
#                radius=1.274,normalize=0,rescale=0,mindiagline = 2,minvertline = 2)
#   return(data)
# 
# }
# 
# apply(FinalData,1,CRQA)
# 
#   RespCRQA= crqa(data$Resp1, data$Resp2, delay=29, embed=3,
#                radius=0.596,normalize=0,rescale=0,mindiagline = 2,minvertline = 2)
#   HrCRQA= crqa(data$HR1, data$HR2, delay=21, embed=14,
...
CRQA = function(data) {
  RespCRQA = crqa(data$Resp1, data$Resp2, delay = 29, embed = 3,
                   radius = 0.596, normalize = 0, rescale = 0,
  ...
  HrCRQA = crqa(data$HR1, data$HR2, delay = 21, embed = 14,
                radius = 1.274, normalize = 0, rescale = 0,
                mindiagline = 2, minvertline = 2)
