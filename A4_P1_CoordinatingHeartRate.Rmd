...
```{r}
DataHR=subset(FinalData1[FinalData1$type=="HR",])
DataResp=subset(FinalData1[FinalData1$type=="Resp",])


Model13=lmer(RR~Condition +(1|Study), DataHR)
summary(Model13)

Model14=lmer(RR~Condition +(1|Study), DataResp)
summary(Model14)

Model15=lmer(ENTR~Condition +(1|Study), DataHR)
summary(Model15)

Model16=lmer(ENTR~Condition +(1|Study), DataResp)
summary(Model16)

Model17=lmer(L~Condition +(1|Study), DataHR)
summary(Model17)

Model18=lmer(L~Condition +(1|Study), DataResp)
summary(Model18)
```
